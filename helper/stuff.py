    ...
    await event.reply(
        ...
        buttons=[
            ...
            [
                ...
                Button.url("DEVELOPER", url="https://t.me/kashmir_1),
...
async def beck(event):
    ok = await event.client(GetFullUserRequest(event.sender_id))
    await event.edit(
        f"Asalamalaikum `{ok.user.first_name}`\nAsalam alikum waramhatullahi wabarkatu bayo  te benaenyo Be chus video compressbot agr ne pai che  tekya gov tyale prechuv yath groups manx @Dsrs_Group.\nVideoksize kran be kam quality kharab gaxene bager\nU BE deme screenshot/BAye sample video te.",
        buttons=[
            [Button.inline("HELP", data="ihelp")],
            [
                Button.url("LOGS", url="https://t.me/Dsrs_Group"),
